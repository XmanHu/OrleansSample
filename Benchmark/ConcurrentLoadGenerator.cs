...
namespace Benchmark
{
    public sealed class ConcurrentLoadGenerator<TState>
    {
        ...
        public async Task Run()
        {
            ...
            _ = Task.Run(async () => { try { await completion; sw.Stop(); } catch { } finally { this.completedBlocks.Writer.Complete(); } });
            ...
            Console.WriteLine("Throughput is " + this.numWorkers * blocksPerWorker * requestsPerBlock / sw.Elapsed.TotalSeconds);
